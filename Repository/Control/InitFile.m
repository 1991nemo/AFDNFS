...
% Define System - Put all the measurable states together and nonmeasurable
% states together/partition the system
A = [1 1 1 4; 2 3 5 4; 4 0 3 7; 3 7 9 14];
B = [1 1 1 1]';
C = eye(size(A));
D = 0;
sys = ss(A,B,C,D);

% Define Desired location for System Poles
DP = [-8 -9 -10 -11];
K = place(A,B,DP);

% Define Full-State Observer
%%
