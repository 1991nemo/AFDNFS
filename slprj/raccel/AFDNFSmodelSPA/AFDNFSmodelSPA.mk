...
MODEL                   = AFDNFSmodelSPA
MODULES                 = rt_logging.c AFDNFSmodelSPA.c AFDNFSmodelSPA_capi.c AFDNFSmodelSPA_data.c AFDNFSmodelSPA_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = AFDNFSmodelSPA.exe
MAKEFILE                = AFDNFSmodelSPA.mk
MATLAB_ROOT             = Z:\ProFiles\x64\MATLAB\R2020a
ALT_MATLAB_ROOT         = Z:\ProFiles\x64\MATLAB\R2020a
MATLAB_BIN              = Z:\ProFiles\x64\MATLAB\R2020a\bin
ALT_MATLAB_BIN          = Z:\ProFiles\x64\MATLAB\R2020a\bin
MASTER_ANCHOR_DIR       = 
START_DIR               = X:\AH8EAF~1.KH\HomeWork\04-PRA~1\AFDNFS\AFDNFS~1
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 15
BUILDARGS               =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="Z:\\ProFiles\\x64\\MATLAB\\R2020a" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = AFDNFSmodelSPA_ref.rsp
COMPILER_COMMAND_FILE     = AFDNFSmodelSPA_comp.rsp
...
rtiostream_utils.obj : Z:\ProFiles\x64\MATLAB\R2020a\toolbox\coder\rtiostream\src\utils\rtiostream_utils.c
	@cmd /C "echo ### Compiling Z:\ProFiles\x64\MATLAB\R2020a\toolbox\coder\rtiostream\src\utils\rtiostream_utils.c
	$(CC) $(CFLAGS) Z:\ProFiles\x64\MATLAB\R2020a\toolbox\coder\rtiostream\src\utils\rtiostream_utils.c
